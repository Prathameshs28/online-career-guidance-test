<%-- 
    Document   : Contact Us
    Created on : Feb 23, 2020, 12:30:09 PM
    Author     : admin
--%>
    ...
    <body>
       ...
       <div class="about_Para">
        ...
        Follow our   youtube channel CareerGuide    
                ...
                <center><button type="submit" name="btnn" class="btn btn-primary" value="Back"><a href="A_HomePage.jsp" style="color:white">Back</a></button></center>
              <br><br>               
            </div>
    </body>
</html>   